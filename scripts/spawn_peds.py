...
def spawn_peds(client,args):
    ...
    # TODO: How are these transform points decided
    # right-top
    ...
    SpawnActor = carla.command.SpawnActor # Command adaptation of spawn_actor() in carla.World
    ...
    for i in range(4):
        ...
        if walker_bp.has_attribute('speed'):
            if (random.random() > percentagePedestriansRunning): # TODO: Change percentagePedestriansRunning var into percentage
                # walking
